...
export function createUrlFromFilepath ({ filepath, baseDir }) {
...
export function source (baseDir, globs, { extensions = {} } = {}) {
  return root => {
    assert(
